...
<html lang="en">
    <head>
        ...
        <link href="<?php echo \Classes\URL::base("app/public/css/style.css") ?>" rel="stylesheet">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="<?php echo \Classes\URL::base("patient/add"); ?>">Paciente</a></li>
                        <li><a href="<?php echo \Classes\URL::base("medic/add"); ?>">Medico</a></li>
                        <li><a href="<?php echo \Classes\URL::base("consultation/add"); ?>"> Consulta</a></li>
                    </ul>
                </div>
            </div>
        </div>
